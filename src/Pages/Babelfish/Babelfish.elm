...
view taco model =
    grid [ Options.id "top", css "max-width" "1280px" ]
        [ cell
            ...
            , showText div Typo.body1 "The table is limited to showing 4 languages simultaneously. When there are more languages available, you can choose other languages in the table header menus."
